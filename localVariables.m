...
% Locally static variables
locVars.rawDataDir ='C:\Users\John.John-PC\Documents\MATLAB\CFS_Checkerboard\Data_Freq_Raw\'; % Where individual blocks' files are stored. Used in analyze_concatenateData
locVars.resultsDir = 'C:\Users\John.John-PC\Documents\MATLAB\CFS_Checkerboard\Data_Freq_Concat\'; % Where the concatenated+analyzed .mat files are stored. Used in analyze_concatenateData, analyze_freqAccuracy, analyze_plotFreqAccuracy
locVars.figsDir = 'C:\Users\John.John-PC\Documents\MATLAB\CFS_Checkerboard\Data_Freq_Figures\'; % Where plots .jpeg are stored. Used in analyze_plotFreqAccuracies
...
locVars.subjFilter = [10]; %1, 2,..N. WHICH SUBJECTS to CONCATENATE and ANALYZE; produces BOTH INDIVIDUAL and GROUP analysis files
locVars.whichPlot = [1]; % 1, 2, 3.  WHICH PLOTS to draw; 1: indv accuracies (+z); 2: group means (+z); 3 subjective accuracies
