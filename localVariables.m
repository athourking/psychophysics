...
% Locally static variables
locVars.rawDataDir ='./Data/FInal_Subjects_Frequency/'; % Where individual blocks' files are stored. Used in analyze_concatenateData
locVars.resultsDir = './Data_results/'; % Where the concatenated+analyzed .mat files are stored. Used in analyze_concatenateData, analyze_freqAccuracy, analyze_plotFreqAccuracy
locVars.figsDir = './Figures/Final_Subjects_Frequency/'; % Where plots .jpeg are stored. Used in analyze_plotFreqAccuracies

% Locally changing variables
locVars.fileNamesIn = 'Sfb*.mat'; % 'Sfb*.mat' % FROM WHICH raw data FILES to CONCATENATE the CHOSEN SUBJECTS data matrix; Used in analyze_concatenateData
