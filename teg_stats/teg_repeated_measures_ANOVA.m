...
%
% Other inputs are optional and currently not intended for serious use!
%
...
for iPred = 1:length(factorStarts),
    ...
    for iBetwInt = 0:length(bfactorStarts1),
        ...
        [F, df1, df2, p, SSM, SSE, MSM, MSE, eta, eps0, bModel, X_ind, dfM_adj, dfE_adj] = teg_RMF_ANOVA(expanded0, X0, B, Bcoder);
        ...
        if iPred > 0,
            ...
            thisLabel = ['Between-factor only: ' betwStr];
        end;
